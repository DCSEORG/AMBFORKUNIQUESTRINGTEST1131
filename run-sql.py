...
Imports the database schema from Database-Schema/database_schema.sql
"""
import pyodbc
import struct
from azure.identity import AzureCliCredential

# Database connection settings - Update these with your deployment values
SERVER = "sql-expensemgmt-UNIQUESUFFIX.database.windows.net"
DATABASE = "Northwind"
